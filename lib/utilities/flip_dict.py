"""
Taken from http://code.activestate.com/recipes/576968-flipdict-python-dict-that-also-maintains-a-one-to-/
and modified for python3
"""
...
class Flipdict(dict):
    ...
    *new* key to the value V will raise KeyError::
    ...
    def update(self, other=None, **kwargs):
        ...
        if other is None:
            pass
        elif hasattr(other, 'items'):  # items saves memory and lookups
